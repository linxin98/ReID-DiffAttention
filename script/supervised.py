...
if __name__ == '__main__':
    ...
    base_optimizer = Adam(base_model.parameters(), lr=init_lr)
    ...
    center_optimizer = SGD(base_model.parameters(), lr=init_lr)
    ...
    for epoch in range(1, epochs + 1):
        ...
        for images, class_indexs, _, _ in train_loader:
            ...
            # id loss
            id_loss = id_loss_function(predict_classes, copy.deepcopy(class_indexs)).item() * id_loss_weight
            # triplet loss
        ...
        if epoch % val_per_epochs == 0:
            ...
            with torch.no_grad():
                ...
                for query_batch, (query_image, _, pids, camids) in enumerate(query_loader):
                    ...
                    query_features.append(query_image)
                ...
                for gallery_batch, (gallery_image, _, pids, camids) in enumerate(gallery_loader):
                    ...
                    gallery_features.append(gallery_image)
